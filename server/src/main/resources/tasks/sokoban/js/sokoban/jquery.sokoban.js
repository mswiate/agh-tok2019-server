  ...
  $.fn.sokoban = function () {
    return this.each(function(){
      ...
      if ( !ctl && !elm.children().length ) {
        ...
        document.addEventListener('move-up', function(){sokobano.keyhandler({keyCode: 38})})
        document.addEventListener('move-down', function(){sokobano.keyhandler({keyCode: 40})})
        document.addEventListener('move-left', function(){sokobano.keyhandler({keyCode: 37})})
        document.addEventListener('move-right', function(){sokobano.keyhandler({keyCode: 39})})
        document.addEventListener('restart-level', function(){sokobano.keyhandler({keyCode: 27})})
